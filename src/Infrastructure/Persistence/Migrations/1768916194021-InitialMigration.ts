...
export class InitialMigration1768916194021 implements MigrationInterface {
    name = 'InitialMigration1768916194021'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "daily_allocation" ("id" SERIAL NOT NULL, "date" date NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_509326493150db88ae350675208" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "allocation_line" ("id" SERIAL NOT NULL, "allocationId" integer NOT NULL, "clientId" integer NOT NULL, "recipeId" integer NOT NULL, "quantityNeeded" integer NOT NULL, "quantityPackaged" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_87f7e78e6004c7b232efc4ccb12" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "package" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "datePackage" date NOT NULL, "status" "public"."package_status_enum" NOT NULL DEFAULT '0', "clientId" integer NOT NULL, "addressId" integer NOT NULL, CONSTRAINT "REL_f2910517fa70c5ebf0a073ee7c" UNIQUE ("addressId"), CONSTRAINT "PK_308364c66df656295bc4ec467c2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "package_item" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "recipeId" integer NOT NULL, "packageId" integer NOT NULL, CONSTRAINT "PK_b9830060b4e555fe0e1bd97b577" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TABLE "order" ("id" SERIAL NOT NULL, "dateOrdered" date NOT NULL, "dateCreatedOn" date NOT NULL, "status" "public"."order_status_enum" NOT NULL DEFAULT '0', CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."order_item_status_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TABLE "order_item" ("id" SERIAL NOT NULL, "status" "public"."order_item_status_enum" NOT NULL DEFAULT '0', "quantityPlanned" integer NOT NULL, "quantityPrepared" integer NOT NULL DEFAULT '0', "quantityDelivered" integer NOT NULL DEFAULT '0', "recipeId" integer NOT NULL, "orderId" integer NOT NULL, CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "dayli_diet" ("id" SERIAL NOT NULL, "date" date NOT NULL, "nDayPlan" integer NOT NULL, "mealPlanId" integer, CONSTRAINT "PK_b914639284df0b263e3f31e2c51" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "meal_plan" ("id" SERIAL NOT NULL, "startDate" date NOT NULL, "endDate" date NOT NULL, "durationDays" integer NOT NULL, "calendarId" integer, "clientId" integer, CONSTRAINT "REL_5868e8024da2e6cdc4bf716ab5" UNIQUE ("calendarId"), CONSTRAINT "PK_b526e5597b340a2c47380a5033d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "date" date NOT NULL, "address" character varying NOT NULL, "reference" character varying NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "calendarId" integer NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
