...
export class InitialMigration1761665776651 implements MigrationInterface {
    name = 'InitialMigration1761665776651'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "daily_allocation" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_509326493150db88ae350675208" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "package" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "datePackage" TIMESTAMP NOT NULL, "status" "public"."package_status_enum" NOT NULL DEFAULT '0', "clientId" integer NOT NULL, "addressId" integer NOT NULL, CONSTRAINT "REL_f2910517fa70c5ebf0a073ee7c" UNIQUE ("addressId"), CONSTRAINT "PK_308364c66df656295bc4ec467c2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "package_item" ("id" SERIAL NOT NULL, "recipeId" integer NOT NULL, "packageId" integer NOT NULL, CONSTRAINT "PK_b9830060b4e555fe0e1bd97b577" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "address" character varying NOT NULL, "reference" character varying NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "calendarId" integer NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
